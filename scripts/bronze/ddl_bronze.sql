...
-- Drop and Create bronze.erp_pxx_cat_g1v2
IF OBJECT_ID('bronze.erp_pxx_cat_g1v2', 'U') IS NOT NULL
    DROP TABLE bronze.erp_pxx_cat_g1v2;
GO
CREATE TABLE bronze.erp_pxx_cat_g1v2(
    id NVARCHAR(50),
    cat NVARCHAR(50),
    subcat NVARCHAR(50),
